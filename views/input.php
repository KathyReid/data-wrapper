...
<div class="screen" id="input">
	...
	<div id="tutorial">
		<p id="tutorial_fill"><?php echo _("Try DataWrapper with some sample data") ?></p>
		<p id="tutorial_explain" style="display:none"><?php echo _("Sample data: unemployment among the population age 25 and over in 6 European metropolis. Source: Eurostat.") ?></p>
	</div>
